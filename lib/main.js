...
var _MuteToolbar = require('./mute-toolbar');
...
//
function activate() {
  _nylasExports.ComponentRegistry.register(_MuteToolbar2.default, {
...
//
function deactivate() {
  _nylasExports.ComponentRegistry.unregister(_MuteToolbar2.default);
}
